...
func init() {
	proto.RegisterType((*Greeting)(nil), "naryGreet.Greeting")
	proto.RegisterType((*GreetRequest)(nil), "naryGreet.GreetRequest")
	proto.RegisterType((*GreetResponse)(nil), "naryGreet.GreetResponse")
}
...
var fileDescriptor_2d82eb17080e41fe = []byte{
	...
	0x41, 0x51, 0x7e, 0x49, 0xbe, 0x10, 0x27, 0x5c, 0x40, 0xc9, 0x8b, 0x8b, 0x03, 0xcc, 0xc8, 0xcc,
	...
	0x02, 0x25, 0x7b, 0x2e, 0x1e, 0xb0, 0x59, 0x41, 0xa9, 0x85, 0xa5, 0xa9, 0xc5, 0x25, 0x42, 0xfa,
	0x5c, 0x1c, 0xe9, 0x50, 0xb3, 0xc1, 0xa6, 0x71, 0x1b, 0x09, 0xeb, 0x21, 0x9c, 0x02, 0xb3, 0x36,
	0x08, 0xae, 0x48, 0x49, 0x9d, 0x8b, 0x17, 0x6a, 0x40, 0x71, 0x41, 0x7e, 0x5e, 0x71, 0xaa, 0x90,
	0x18, 0x17, 0x5b, 0x51, 0x6a, 0x71, 0x69, 0x4e, 0x09, 0xd4, 0x35, 0x50, 0x9e, 0x91, 0x0f, 0xd4,
	0xa6, 0xe0, 0xd4, 0xa2, 0xb2, 0xcc, 0xe4, 0x54, 0x21, 0x1b, 0x2e, 0x56, 0x30, 0x5f, 0x48, 0x1c,
	0xdd, 0x02, 0xa8, 0x5b, 0xa4, 0x24, 0x30, 0x25, 0x20, 0x76, 0x28, 0x31, 0x38, 0x09, 0x44, 0xf1,
	0x81, 0x83, 0x48, 0x1f, 0x2c, 0xe1, 0x18, 0xe0, 0x99, 0xc4, 0x06, 0x0e, 0x27, 0x63, 0x40, 0x00,
	0x00, 0x00, 0xff, 0xff, 0x18, 0x3e, 0xca, 0xeb, 0x49, 0x01, 0x00, 0x00,
}
...
func (c *greetServiceClient) Greet(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/naryGreet.GreetService/Greet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _GreetService_Greet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/naryGreet.GreetService/Greet",
	}
...
var _GreetService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "naryGreet.GreetService",
